...
- [📖 \[Pokémon-Web-App\] ](#-Pokémon-Web-App-)
...
# 📖 [Pokémon Web App] <a name="about-project"></a>
...
- **[Comment button will get pop-up for a comment section from the API]**
-**[Add a comment button will save a comment and shown to the user]**
...
- [Live Demo Link](https://lawmsangi.github.io/pokemon-api-project/dist/)

## 💻 Getting Started <a name="getting-started"></a>

### setup
<p>Clone this repository to your desired folder</p>
<a href ="https://github.com/Lawmsangi/pokemon-api-project.git"></a>
